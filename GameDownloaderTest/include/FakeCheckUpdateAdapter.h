...
public:
  ...
  void setPreHook(const std::function<bool (const P1::Core::Service*, P1::GameDownloader::CheckUpdateHelper::CheckUpdateType)>& f);
...
private:
  ...
  bool _isUpdate;
  std::function<bool (const P1::Core::Service*, P1::GameDownloader::CheckUpdateHelper::CheckUpdateType)> _preHook;
