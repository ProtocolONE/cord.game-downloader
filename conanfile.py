...
#    version = "1.0"
    ...
    requires = "Qt/5.5.1@common/stable", "UpdateSystem/1.0.0@common/stable", "LibtorrentWrapper/1.0.0@common/stable", "Core/1.0.0@common/stable", "Settings/1.0.0@common/stable"
    build_requires = "Qt/5.5.1@common/stable", "UpdateSystem/1.0.0@common/stable", "LibtorrentWrapper/1.0.0@common/stable", "Core/1.0.0@common/stable", "Settings/1.0.0@common/stable"
...
<Project xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <ItemDefinitionGroup>
    ...
    def package_info(self):
      ...
      if self.options.shared == "False":
        self.cpp_info.defines.append("DOWNLOADSERVICE_STATIC_LIB")
